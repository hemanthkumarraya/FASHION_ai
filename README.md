...
1. Push code to GitHub (**never push** `secrets.toml`)
2. Go to https://share.streamlit.io
3. Click **"New app"** → Connect your repo → Set `app.py` as entry
4. Click **"Advanced settings"** → Paste your secrets:
   ```toml
   GROQ_API_KEY = "gsk_your_actual_key_here"
   ```
5. Click **Deploy** — your app gets a public URL in minutes!
